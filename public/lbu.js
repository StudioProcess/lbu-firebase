...
// https://gist.github.com/runeb/c11f864cd7ead969a5f0
function getImageRotation( buffer ) {
  ...
  return new Promise(resolve => {
    input.addEventListener('change', e => {
      ...
      reader.onload = e => {
        ...
        let dataURL = "data:" + file.type + ";base64," + arrayBufferToBase64(buffer);
        let rotation = opts.exifRotate ? getImageRotation(buffer) : '';
